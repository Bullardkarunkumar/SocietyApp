<%@ Page Title="" Language="C#" MasterPageFile="~/MudarMasterNew.master" AutoEventWireup="true" CodeFile="SupplierHome.aspx.cs" Inherits="SupplierHome" %>
    ...
    <div class="row margin-bottom-30">
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable table-scrollable-borderless">
                        <asp:Repeater ID="rptFiveOrders" runat="server">
                            <HeaderTemplate>
                                <table class="table table-hover table-light mudargrid" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th style="width: 10%">Order ID</th>
                                            <th style="width: 70%">Buyer Code</th>
                                            <th style="width: 10%">Branch Order Date</th>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="fit"><%# Eval("BranchPOID") %>
                                    </td>
                                    <td class="fit"><%# Convert.ToDateTime(Eval("BranchOrderDate")).ToString("dd/MM/yyyy") %>
                                    </td>
        ...
        <div class="col-lg-6 col-xs-12 col-sm-12">
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable table-scrollable-borderless">
                        <asp:Repeater ID="rptFiveLotSamples" runat="server">
                            <HeaderTemplate>
