<%@ Page Title="" Language="C#" MasterPageFile="~/MudarMaster.master" AutoEventWireup="true" CodeFile="PackingRegister.aspx.cs" Inherits="BranchReports_PackingRegister" EnableEventValidation="false" %>
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="gvBlendreg" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="CreatedDate" HeaderText="Packing Date" ItemStyle-HorizontalAlign="Center"
                                ...
                                <asp:BoundField DataField="Packing25" HeaderText="25kg Drum" />
                                <asp:BoundField DataField="Packing180" HeaderText="180kg Drum" />
                                ...
                                <asp:BoundField DataField="PackedBy" HeaderText="Packed By" />
