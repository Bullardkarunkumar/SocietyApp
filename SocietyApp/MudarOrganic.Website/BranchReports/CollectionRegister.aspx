<%@ Page Title="" Language="C#" MasterPageFile="~/MudarMaster.master" AutoEventWireup="true" CodeFile="CollectionRegister.aspx.cs" Inherits="BranchReports_CollectionRegister" %>
                    ...
                    <td colspan="3">
                        <asp:GridView ID="gvNewCollect" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CreatedDate" HeaderText="Received Date" SortExpression="CreatedDate" DataFormatString="{0:dd MMM yyyy}"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="Lotnumber" HeaderText="Batchno" SortExpression="Lotnumber" />
                                <asp:BoundField DataField="CollectionQty" HeaderText="Quantity" ItemStyle-HorizontalAlign="Center"
                                    DataFormatString="{0:0.00}" SortExpression="CollectionQty"></asp:BoundField>
                                <asp:BoundField DataField="Whether" HeaderText="Whether Seal intact?" SortExpression="Lotnumber" />
                                <asp:BoundField DataField="ReceivedBy" HeaderText="Received By" SortExpression="Lotnumber" />
                                <asp:BoundField DataField="Remarks" HeaderText="Remarks" SortExpression="Lotnumber" />
                            </Columns>
