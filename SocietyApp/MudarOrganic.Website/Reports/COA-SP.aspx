<%@ Page Title="" Language="C#" MasterPageFile="~/MudarMaster.master" AutoEventWireup="true" CodeFile="COA-SP.aspx.cs" Inherits="Reports_COA_SP" %>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="1">
                                            ...
                                            <tr>
                                                <td>
                                                     <asp:TextBox ID="txtCarvone" runat="server" Text="0" />
                                                </td>
                                                 <td>
                                                    <asp:TextBox ID="txtCarvoneAnalysis" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                   <asp:TextBox ID="txtCarvoneLow" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                  <asp:TextBox ID="txtCarvoneHigh" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtCarvoneTMA" runat="server" Text="0" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
