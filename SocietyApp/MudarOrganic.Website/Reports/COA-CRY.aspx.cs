...
public partial class Reports_COA_CRY : System.Web.UI.Page
{
    ...
    private bool generatePdf()
    {
        ...
        result = reportObj.OrderReportsPathInsertandUpdate(Convert.ToInt32(orderid), Convert.ToInt32(Session["BranchOrderID_S"].ToString()), path, "Bhanu", string.Empty, rtypeObj.CRY);
        return result;
    }
}
