<%@ Page Title="" Language="C#" MasterPageFile="~/MudarMaster.master" AutoEventWireup="true" CodeFile="COA-BO.aspx.cs" Inherits="Reports_COA_BO" %>
                                        ...
                                        <table width="100%" border="1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "BatchID")%>'/>
                                                </td>
                                                <td>
                                                    Drum Ref
                                                </td>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="1">
                                            ...
                                            <tr>
                                                <td>
                                                     <asp:TextBox ID="txtMethyleChevicol" runat="server" Text="0" />
                                                </td>
                                                 <td>
                                                    <asp:TextBox ID="txtMethyleChevicolAnalysis" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                   <asp:TextBox ID="txtMethyleChevicolLow" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                  <asp:TextBox ID="txtMethyleChevicolHigh" runat="server" Text="0" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtMethyleChevicolTMA" runat="server" Text="0" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
