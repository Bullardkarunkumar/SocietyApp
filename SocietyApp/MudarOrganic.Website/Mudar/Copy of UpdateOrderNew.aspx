<%@ Page Language="C#" Title="Mudar Order Process" MasterPageFile="~/MudarMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Copy of UpdateOrderNew.aspx.cs" Inherits="Admin_UpdateOrder" %>
    ...
    <div id="content_area_Home" style="height: auto">
        ...
        <table width="90%" align="center">
            <tr id="tr" runat="server" visible="false">
                <td colspan="3" align="center">Order ID  :&nbsp;
                    <asp:Label ID="lblBranchOrderID" runat="server" Text="" ForeColor="#FF6600" /></td>
            </tr>
            <tr>
                <td width="30%" align="center">Branch Order ID</td>
                <td width="30%" align="center">Branch Purchase Order</td>
                <td width="30%" align="center">Branch Purchase Order ID</td>
            </tr>
            <tr>
                <td width="30%" align="center">
                    <asp:Label ID="lblorderID" runat="server" Text="" ForeColor="#FF6600" /></td>
                <td width="30%" align="center">&nbsp;<asp:HyperLink ID="hlBranchPDF" runat="server" Text="Open" Target="_blank" />

                </td>
                <td width="30%" align="center">
                    <asp:Label ID="lblBPOID" runat="server" Text="" ForeColor="#FF6600" />
                </td>
            </tr>
            <tr>
                <td width="30%" align="center">Branch Order Type</td>
                <td width="30%" align="center">Lot Sample (Pdf)</td>
                <td width="30%" align="center">
                    <asp:Label ID="lblBLs" runat="server" ForeColor="#FF6600" /></td>
            </tr>
            <tr>
                <td width="30%" align="center">
                ...
                <td width="30%" align="center">
                    <asp:HyperLink ID="hlLSpdf" runat="server" Text="Open" Target="_blank" /></td>
                <td width="30%" align="center">Lot Sample ID</td>
            </tr>
        ...
        <div id="accordion" style="background: none !important; border: none !important;">
            ...
            <div style="background: #E9E1CC">
                <table align="center">
                    <tr>
                        <td colspan="6" align="center">Product Name<br />
                                        ...
                                        <asp:GridView ID="gvCollectedFromFarmer" runat="server" AutoGenerateColumns="False" DataKeyNames="FarmerCode,FarmerID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CreatedDate" HeaderText="Created Date" ItemStyle-HorizontalAlign="Center"
                                                    DataFormatString="{0:dd MMM yy}"></asp:BoundField>
                                            </Columns>
                                    ...
                                    <td>
                                        <asp:GridView ID="gvCollectedFromPreorder" runat="server" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CreatedDate" HeaderText="Created Date" ItemStyle-HorizontalAlign="Center"
                                                    DataFormatString="{0:dd MMM yy}" HtmlEncode="false"></asp:BoundField>
                                            </Columns>
                                            <HeaderStyle CssClass="gvheader" />
                                            <AlternatingRowStyle CssClass="gvalternate" />
                                            <RowStyle CssClass="gvnormal" />
                    ...
                    <tr id="trShowDetails" runat="server" visible="false">
                        <td colspan="2" align="center">Order Quantity<br />
                        ...
                        <td colspan="2" align="center">Remaining Quantity<br />
                    ...
                    <tr id="trOtherFarmer" runat="server" visible="false">
                        <td colspan="2" align="center">Other Farmer Name<br />
                            <asp:TextBox ID="txtOtherFarmers" runat="server" Text="0" Width="140px"></asp:TextBox>
                        </td>
                        <td colspan="2">&nbsp;
                        </td>
                        <td colspan="2">Other Farmer Qty<br />
                        ...
                        <td colspan="6">
                            <div id="divFarmerCollecting" runat="server" align="center" visible="false">
                                <table>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <%--Selected Items--%>
                                            <a href="javascript:void(0);" id="ankToggle">Show/Hide Farmer Collection Details</a></td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="text-align: center" id="tdGrid">
                                            <asp:GridView align="center" HorizontalAlign="Center" ID="gvSelectedCollectionDetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                AllowSorting="true" CssClass="grid-view" OnRowEditing="gvSelectedCollectionDetails_RowEditing" OnRowDeleting="gvSelectedCollectionDetails_RowDeleting"
                                                OnRowCancelingEdit="gvSelectedCollectionDetails_RowCancelingEdit" OnRowUpdating="gvSelectedCollectionDetails_RowUpdating"
                                                OnRowDataBound="gvSelectedCollectionDetails_RowDataBound">
                                                <Columns>
                            ...
                            <asp:BoundField DataField="FarmID" HeaderText="Farm ID" />--%>
                                                    <asp:BoundField DataField="FarmerCode" ReadOnly="true" HeaderText="Farmer Code" HeaderStyle-HorizontalAlign="Center"
                                                        ItemStyle-HorizontalAlign="Center" SortExpression="FarmerCode" HeaderStyle-Width="80"></asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="SoldTotalQty" ReadOnly="true" HeaderText="Sold Quanity" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <asp:BoundField DataField="Avaliable" ReadOnly="true" HeaderText="Avaliable Quanity" HeaderStyle-Width="100" ItemStyle-Font-Bold="true"
                                                    ...
                                                    <asp:TemplateField HeaderText="Collect Quanity" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                        <ItemTemplate>
                                                ...
                                                <EmptyDataTemplate>
                                                    <table cellspacing="2" cellpadding="3" rules="all" class="grid-view">
                                                        <tr class="gvheader">
                                                            <th scope="col">Farmer Code
                                                            </th>
                                                            <th scope="col">Farmer Name
                                                            </th>
                                                            <%--<th scope="col">Batch No</th>
                                                        <th scope="col">Actual Quanity
                                                        </th>
                                                        <th scope="col">Sold Quanity
                                                        </th>--%>
                                                            <th scope="col">Avaliable Quanity
                                                            </th>
                                                        ...
                                                        <tr class="gvnormal">
                                                            <td colspan="8" style="font-weight: bold; color: red; text-align: center">No Item(s) collected from farmer yet.
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </EmptyDataTemplate>
                                    ...
                                    <tr id="trCollectGridRow" runat="server" style="display: block">
                                        <td class="tdCollectGrid">
                                            ...
                                            <asp:GridView ID="gvCollecingDetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                HeaderStyle-CssClass="FixedHeader" OnRowDataBound="gvCollecingDetails_RowDataBound">
                                                <Columns>
                                                    <%--<asp:BoundField DataField="FarmerId" HeaderText="Farmer ID" />
                            <asp:BoundField DataField="FarmID" HeaderText="Farm ID" />--%>
                                                    ...
                                                    <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:CheckBox ID="cbCollecting" Width="30px" Class="searchboxx updateqnty" Checked='<%# DataBinder.Eval(Container.DataItem, "Collect")%>' runat="server" onclick="javascript:validateGridQuantity()" AutoPostBack="false" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <HeaderStyle CssClass="gvheader" />
                                                ...
                                                <EmptyDataTemplate>
                                                    <table cellspacing="2" cellpadding="3" rules="all" class="grid-view">
                                                        ...
                                                        <tr class="gvnormal">
                                                            <td colspan="8" style="font-weight: bold; color: red; text-align: center">No Farmer(s) available for selected product in selected ICS(s).
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </EmptyDataTemplate>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <asp:GridView ID="gvPreorderCollection" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="PlantationId,FarmerID,FarmID,CollectionTransactionID">
                                                <Columns>
                                                    <asp:BoundField DataField="Blending_BatchID" HeaderText="Batch ID" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                        ...
                        <td>
                            <div id="divCompletedBlendDetails" align="center" runat="server" visible="false">
                                <table align="center">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:GridView ID="gvBlendCompleted" runat="server" AutoGenerateColumns="False">
                                                <Columns>
                                                    <asp:BoundField DataField="Blending_BatchID" HeaderText="Batch ID" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                            ...
                            <div id="divBlendDetails" runat="server" visible="false">
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="3" align="center">
                                            <asp:GridView ID="gvBlending" runat="server" AutoGenerateColumns="False" DataKeyNames="FarmerCode,FarmerID,FarmID"
                                                OnRowCommand="gvBlending_RowCommand1" CssClass="grid-view">
                                                <Columns>
                                                    <asp:BoundField DataField="FarmerID" HeaderText="Farmer ID" ItemStyle-HorizontalAlign="Center"
                                                        Visible="false"></asp:BoundField>
                                    ...
                                    <tr>
                                        <td colspan="3" align="center">
                                            <asp:Button ID="btnBlendSubmit" runat="server" Text="Submit" CssClass="fb8" OnClick="btnBlendSubmit_Click" />&nbsp;
            ...
            <div style="background: #E9E1CC">
                <table>
                    <tr align="center">
                        <td>
                            <asp:GridView ID="gvFreeze" DataKeyNames="FreezeID,ProductID" runat="server" AutoGenerateColumns="False"
                                BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px"
                                CellPadding="4" ForeColor="Black" GridLines="Vertical" OnRowCommand="gvFreeze_RowCommand">
                                <RowStyle BackColor="#F7F7DE" />
                                <Columns>
                                    <asp:BoundField DataField="ProductName" HeaderText="Product Name" />
                                    <asp:BoundField DataField="Quantity" HeaderText="Quantity" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="FBatchID" HeaderText="F Batch No" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
            ...
            <div style="background: #E9E1CC">
                <div align="center">
                    ...
                    <asp:DropDownList ID="ddlTestProduct" runat="server" AutoPostBack="true" Style="width: 220px;"
                        OnSelectedIndexChanged="ddlTestProduct_SelectedIndexChanged" />
                </div>
                <br />
                <div id="divTestingCompleted" runat="server" visible="false" align="center">
                    <asp:GridView runat="server" ID="gvTestingCompleted" AutoGenerateColumns="false" CssClass="grid-view">
                        <Columns>
                ...
                <div id="divTestResults" runat="server" visible="false">
                    <table>
                        <tr>
                            <td>
                                <asp:GridView ID="gvTesting" runat="server" AutoGenerateColumns="False" CssClass="grid-view"
            ...
            <div style="background: #E9E1CC">
                <table>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            <asp:GridView ID="gvPackingCompleted" runat="server" AutoGenerateColumns="false" CssClass="grid-view">
                                <Columns>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            <asp:Button ID="btnPackingDetailsSubmit" CssClass="fb8" runat="server" Text="Submit"
                                OnClick="btnPackingDetailsSubmit_Click" />&nbsp;
