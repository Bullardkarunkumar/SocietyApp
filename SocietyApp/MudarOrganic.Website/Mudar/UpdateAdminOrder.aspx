<%@ Page Language="C#" Title="Mudar Order Process" MasterPageFile="~/MudarMasterNew.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="UpdateAdminOrder.aspx.cs" Inherits="Admin_UpdateOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content_area_Home" style="height: auto">
        ...
        <div style="background: #E9E1CC; padding-top: 15px">
            <table width="90%" align="center">
                ...
                <tr>
                    ...
                    <td width="30%" align="center">
                        ...
                        <asp:HyperLink ID="hfLS" runat="server" Text="Open" Style="color: #d3d3d3"
                            Target="_blank" />

                    </td>
                    <td width="30%" align="center">
                        <asp:HyperLink ID="hfBrLS" runat="server" Text="Open" Style="color: #d3d3d3"
                            Target="_blank" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="30%" align="center">
                        <asp:HyperLink ID="hfBrPO" runat="server" Text="Open"
                            Target="_blank" />
                    </td>
                </tr>
                <tr align="center" id="trDocus" runat="server" visible="false">
                    <td>Order Documents
                    </td>
                    <td></td>
                    <td>Lot Sample Documents</td>
                </tr>
                <tr id="trDocu" runat="server" visible="false">
                    <td>
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td align="right">Non-Haz Sea:</td>
                                <td>&nbsp;<%--<asp:HyperLink ID="hlHazSea" runat="server" Text="Open" Target="_blank" />--%>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Non-Haz Air:</td>
                                <td>&nbsp;<%----%>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Cover Letter:</td>
                                <td>&nbsp;<%----%>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Fir Cover Letter:</td>
                                <td>&nbsp;
                                </td>
                            </tr>
                        </table>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td align="right">Invoice:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Packing:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink2" runat="server" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Non-Haz Sea:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink3" runat="server" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Non-Haz Air:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink4" runat="server" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Cover Letter:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink5" runat="server" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Fir Cover Letter:</td>
                                <td>&nbsp;<asp:HyperLink ID="HyperLink6" runat="server" Text="Open" Target="_blank" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="3" align="center" style="padding-top: 15px">
                        <asp:Button ID="btnPlaceBrnchOrder" runat="server" Text="Place Order" CommandName="BranchOrder"
                            OnClick="btnPlaceBrnchOrder_Click" CssClass="btn btn-success" />
                        <asp:Button ID="btnDisable" runat="server" Text="Place Order" CssClass="btn btn-default"
                            Visible="false" /></td>
                </tr>
            </table>
            <div id="accordion" style="background: none !important; border: none !important;">
                ...
                <div style="background: #E9E1CC">
                    <table align="center">
                        <tr align="right">
                            ...
                            <td align="center">&nbsp;<asp:HyperLink ID="hlInvoice" runat="server" NavigateUrl="" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr align="right">
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Packing:</td>
                            <td align="center">
                                <asp:HyperLink ID="hlPacking" runat="server" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr align="right">
                            ...
                            <td align="center">
                                <asp:HyperLink ID="hlHazSea" runat="server" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr align="right">
                            ...
                            <td align="center">
                                <asp:HyperLink ID="hlHazAir" runat="server" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr align="right">
                            ...
                            <td align="center">
                                <asp:HyperLink ID="hlCoverLetter" runat="server" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr align="right">
                            ...
                            <td align="center">
                                <asp:HyperLink ID="hlFIRCover" runat="server" Text="Open" Target="_blank" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="padding-top: 15px">
                                <asp:Button ID="btnAdminSkip" runat="server" Text="Skip" CssClass="btn btn-success" OnClick="btnAdminSkip_Click" />
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div id="divLSMsg" align="center" runat="server" visible="false">
                                    <table>
                                        <tr style="background-color: #CE5D5A; color: White; font-size: medium; font-weight: bolder;">
                                            <td colspan="2" align="center">Courier Details</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
                                        </tr>
                                        <tr>
                                            <td align="right">Couier Details</td>
                                            <td>
                                                <asp:TextBox ID="txtLSmsg" runat="server" Height="75px" Width="400px" TextMode="MultiLine" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
                                        </tr>
                ...
                <div style="background: #E9E1CC; text-align: center" align="center">
                    ...
                    <table align="center" cellpadding="5" cellspacing="5" runat="server" id="tblETA">
                        <tr id="trDispatchdetails" runat="server" visible="false">
                            <td>Dispatch Details<asp:Label ID="lblDispathDetails" runat="server" Text="" Visible="false"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtDispatch" runat="server" Height="75px" Width="400px" TextMode="MultiLine" /></td>
                        </tr>
                        <tr>
                            <td>ETA Date<asp:Label ID="lblETAText" runat="server" Text="" Visible="false"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtIntransitDate" runat="server" Height="28px" Width="250px"></asp:TextBox>
