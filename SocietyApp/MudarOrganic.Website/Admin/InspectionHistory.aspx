<%@ Page Title="Mudarorganic-InspectionPlan" Language="C#" MasterPageFile="~/MudarMaster.master" AutoEventWireup="true"
    CodeFile="InspectionHistory.aspx.cs" Inherits="Admin_InspectionHisoy" %>
            ...
            <table align="center">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnPlanOk" runat="server" Text="Submit" CssClass="fb8" OnClick="btnPlanOk_Click" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvPlan" runat="server" DataMember="InspectionID" AutoGenerateColumns="False"
                            CssClass="grid-view" AllowSorting="true" DataKeyNames="FarmerID,InspectorID,InspectionID"
