...
public partial class FarmerReports_AFLEstimation : System.Web.UI.Page
{
    ...
    private void BindGridDetails(string Year)
    {
        ...
        dt = report.GetAFLReportProductionEstimation(icsCode,Year);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void gvFarmerList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            e.Row.Cells[5].Visible = false;// Invisibiling Period Header Cell
    ...
    protected void gvFarmerList_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header) // If header created
        {
            ...
            HeaderCell.HorizontalAlign = HorizontalAlign.Center;
            HeaderCell.ColumnSpan = 7; // For merging three columns (Direct, Referral, Total)
            HeaderCell.CssClass = "HeaderStyle";
            HeaderRow.Cells.Add(HeaderCell);
