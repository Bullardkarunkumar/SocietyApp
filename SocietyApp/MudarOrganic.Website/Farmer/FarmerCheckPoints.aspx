    ...
    <div id="content_area_Home" style="height:auto">
     ...
     <div align="right">
            ...
            <table align="right" style="font-family: Verdana; font-size: 10px; width: 880px"
                ...
                <tr bgcolor="#CCCC99">
                    <td colspan="3">
                        F:First,S:Second,HD:HarvestDate,EH:EstimatedHerbage,AH:ActualHerbage,EO:EstimatedOil,AO:Actual
                        Oil,DD:DistillationDate,DU:DistillationUnit,BN:BatchNo
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="gvYields" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            GridLines="Vertical" Width="865px">
                            <Columns>
                ...
                <tr align="center" bgcolor="#CCCC99">
                    <td colspan="3">
                        Produce Total Quantiy&nbsp; Information
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr><td colspan="2" align="right"><asp:Button ID="btnSubmit" runat="server" CssClass="fb8" Text="Submit" OnClick="btnPdf_Click"/></td>
                <td colspan="1" align="center"><asp:Button ID="btnBack" runat="server" CssClass="fb8" Text="Back"  /></td></tr>
            </table>
            </div>
